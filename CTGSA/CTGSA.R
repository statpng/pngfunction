CTGSA <- function(x, y){
  ...
  #mcp
  c_mcp1 = matrix(sapply( H_Cs1, function(z) mcp(z, Ccri1, gamma=2.0) ), 200, 200, byrow=FALSE )
  t_mcp1 = matrix(sapply( H_Ts1, function(z) mcp(z, Tcri1, gamma=2.0) ), 200, 200, byrow=FALSE )
  
  mcp_Csv1 = svd(abs(c_mcp1))$d;
  mcp_Tsv1 = svd(abs(t_mcp1))$d
  
  #scad
  c_scad1 = matrix(sapply( H_Cs1, function(z) scad(z, Ccri1, gamma=2.0) ), 200, 200, byrow=FALSE )
  t_scad1 = matrix(sapply( H_Ts1, function(z) scad(z, Tcri1, gamma=2.0) ), 200, 200, byrow=FALSE )
